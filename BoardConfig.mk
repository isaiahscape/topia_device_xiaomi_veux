...
ifeq ($
(PRODUCT VIRTUAL_ AB OTA),true) 
BOARD PRODUCTIMAGE_MINIMAL_PARTITION RESERVED SIZE?= true endif

BOARD_PRODUCTIMAGE_EXTFS_INODE_COUNT ?= 1
ifeq ($
(BOARD_PRODUCTIMAGE_MINIMAL_PARTITION_RESERVED_SIZE),true) 
BOARD_PRODUCTIMAGE_PARTITION RESERVED SIZE ?= 188036608 else
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE ?= 1957691392 endif
BOARD_SYSTEMIMAGE_EXTFS_INODE_COUNT ?= -1
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE ?= 94371840
BOARD_SYSTEM_EXTIMAGE_EXTFS_NODE_COUNT ?= -1
